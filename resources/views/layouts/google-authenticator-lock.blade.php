...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>{{ $title ?? 'Google Authentication' }}</title>
            ...
            <div class="col-sm-10 col-md-8 col-lg-6 col-xl-5 col-xxl-4">
                ...
                <div class="card">
                    <div class="card-body p-4 p-sm-5">
                        ...
                        <h5 class="mt-3 mb-0">Привет! Владислав</h5>
                        <p class="mb-0">Google Authenticator</p>
                        <form class="mt-4 row g-0 mx-sm-4">
                            @csrf
                            <div class="col">
                                <input class="form-control me-2 mb-2" type="password" placeholder="Введите свой код" aria-label="User's password" aria-describedby="user-password" />
                            </div>
                            <div class="col-auto ps-2">
                                <button class="btn btn-primary px-3 mb-2" id="user-password" type="button">Войти</button>
                            </div>
                        </form>
                    </div>
                </div>
