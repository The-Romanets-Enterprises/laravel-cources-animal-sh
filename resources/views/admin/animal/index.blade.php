        ...
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{ route("admin.animals.create") }}"
                   class="btn btn-primary mb-3">{{ __('messages.animal.create') }}</a>
                    ...
                    <table class="table table-bordered table-striped">
                        ...
                        @foreach($animals as $animal)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route("admin.animals.edit", ['animal' => $animal->id]) }}"
                                       class="btn btn-info btn-sm float-left">
                                        <i class="fas fa-pencil-alt"></i>
                                    </a>
                                    @if(auth()->user()->role == \App\Enum\Role::ADMIN)
                                        <form action="{{ route("admin.animals.destroy", ['animal' => $animal->id]) }}"
